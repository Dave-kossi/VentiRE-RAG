...
if __name__ == "__main__":
    ...
    PDF_INPUT = "./PDF_DIR/protocole_ventilation_re2020_v2.pdf"
    MD_OUTPUT = "./data_source/protocole_ventilation_re2020_v2.md"
    ...
    if not os.environ.get("LLAMA_CLOUD_API_KEY"):
        ...
        if os.path.exists(PDF_INPUT):
            ...
            print(f"👉 Assurez-vous d'avoir bien déposé le fichier 'protocole_ventilation_re2020_v2.pdf' dans le dossier './pdfs_a_traiter/'.")